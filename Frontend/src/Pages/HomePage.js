...
function HomePage() {
  return (
    <div className="home-page">
      ...
      {/* Header Section */}
      <header>
        <h1>Welcome Artisans! To There Sales Of Creativity</h1>
      </header>
      ...
      {/* Banner Section for Products */}
      <div className="section-banner products-banner">
        <div className="banner-content">
          <h2>Our Products</h2>
          <p>"Explore the variety of handcrafted products created with love and skill."</p>
          <Link to='/product-management'><button className="cta-button">View Products</button></Link>
        </div>
      </div>
      ...
      <div className="section-banner events-banner">
        <div className="banner-content">
          ...
          <button className="cta-button">View Events</button>
        </div>
      </div>
